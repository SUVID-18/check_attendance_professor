...
class RegisterPageViewModel {
  ...
  /// 회원가입 페이지의 동작을 담당하는 클래스의 생성자
  ///
  /// 회원가입 페이지에서 필요한 부분에 대입시키면 된다.
  ///
  ///
  /// ```dart
  ...
  /// ),
  ///```
  factory RegisterPageViewModel() => RegisterPageViewModel._init();

  RegisterPageViewModel._init();
}
